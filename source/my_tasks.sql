...
INSERT INTO `my_tasks` (`id`, `order_id`, `customer_id`, `payment_fee`, `warranty_period`, `status`, `cre_time`, `place_time`, `note`) VALUES
(4, 204, 20, 100, '1 tháng', 0, '2022-07-05 21:30:09', 'Chiều 6/7/22', 'Đi chợ'),
(5, 205, 21, 0, '', 0, '2022-07-05 21:33:00', 'Mai', ''),
(6, 205, 21, 0, '', 0, '2022-07-05 21:33:00', 'Mai', '');
...
ALTER TABLE `my_tasks`
  ...
  ADD KEY `FR_orders_tasks` (`order_id`);
...
ALTER TABLE `my_tasks`
  ...
  ADD CONSTRAINT `FR_orders_tasks` FOREIGN KEY (`order_id`) REFERENCES `my_orders` (`id`);
COMMIT;
