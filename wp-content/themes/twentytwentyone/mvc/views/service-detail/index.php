...
<?php $row = mysqli_fetch_array($data['service']) ?>
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    ...
                    <div class="custombox clearfix">
                        ...
                        <div class="row">
                            <?php 
                                while($rowService = mysqli_fetch_array($data['service-popular'])) {
                            ?>
                            <div class="col-lg-6">
                                <div class="blog-box">
                                    <div class="post-media">
                                        <a href="/wordpress/services?id=<?php echo($rowService['id'])?>" title="">
                                        <img src="<?php echo($row['thumbnail']); ?>" alt="" class="img-fluid">
                                    ...
                                    <div class="blog-meta">
                                        <h4><a href="/wordpress/services?id=<?php echo($rowService['id'])?>" title=""><?php echo($rowService['title']); ?></a></h4>
                                        <small><a href="#" title=""><?php echo(date_format(date_create($rowService['mod_time']),"d F Y")); ?></a></small>
                                    </div><!-- end meta -->
                                </div><!-- end blog-box -->
                            </div><!-- end col -->
                            <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form-wrapper" id="commentForm">
                                    ...
                                    <input type="hidden" class="form-control" id="comment-type" name="comment-type" value="service" />
                ...
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <div class="blog-list-widget">
                            ...
                            <?php 
                                while($data['forums_popular'] && $rowForum = mysqli_fetch_array($data['forums_popular'])) {
                            ?>
                                <a href="/wordpress/forums?id=<?php echo($rowForum['id'])?>" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <h5 class="mb-1"><?php echo($rowForum['title'])?></h5>                                                
                                        <small><?php echo(date_format(date_create($rowForum['mod_time']),"d F Y")); ?> </small>
                                        <small><i class="fa fa-eye"></i> <?php echo($rowForum['view_count']) ?> </small>
                                    </div>
                                </a>
                            <?php } ?>
                            </div>
