...
<?php $row = mysqli_fetch_array($data['forum']) ?>
                ...
                <div class="page-wrapper">
                    <div class="blog-title-area text-center">
                        ...
                        <div class="blog-meta big-meta">
                            <small><a href="#" title=""><?php echo(date_format(date_create($row['mod_time']),"d F Y")) ?></a></small>
                            <small><a href="#" title="">by <?php echo($row['author_name']) ?></a></small>
                    ...
                    <div class="custombox authorbox clearfix">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <h4><a href="#"><?php echo($row['author_name']); ?></a></h4>
                    ...
                    <div class="custombox clearfix">
                        ...
                        <div class="row">
                            <?php 
                                while($rowForum = mysqli_fetch_array($data['forum-popular'])) {
                            ?>
                            <div class="col-lg-6">
                                <div class="blog-box">
                                    <div class="post-media">
                                        <a href="/wordpress/posts?id=<?php echo($rowForum['id'])?>" title="">
                                    ...
                                    <div class="blog-meta">
                                        <h4><a href="/wordpress/forums?id=<?php echo($rowForum['id'])?>" title=""><?php echo($rowForum['title']); ?></a></h4>
                                        <small><a href="#" title=""><?php echo($rowForum['author_name']) ?></a></small>
                                        <small><a href="#" title=""><?php echo(date_format(date_create($rowForum['mod_time']),"d F Y")); ?></a></small>
                                    </div><!-- end meta -->
                                </div><!-- end blog-box -->
                            </div><!-- end col -->
                            <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form-wrapper" id="commentForm">
                                    ...
                                    <input type="hidden" class="form-control" id="comment-type" name="comment-type" value="forum" />
                ...
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <div class="blog-list-widget">
                            ...
                            <?php 
                                while($data['posts_popular'] && $rowPost = mysqli_fetch_array($data['posts_popular'])) {
                            ?>
                                <a href="/wordpress/posts?id=<?php echo($rowPost[0])?>" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <h5 class="mb-1"><?php echo($rowPost['post_title'])?></h5>                                      
                                        <small><?php echo(date_format(date_create($rowPost['post_modified']),"d F Y")); ?> </small>
                                        <small><i class="fa fa-eye"></i> <?php echo($rowPost['view_count']) ?> </small>
                                    </div>
                                </a>
                            <?php } ?>
                            </div>
